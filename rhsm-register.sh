...
sudo subscription-manager attach --pool=<pool id here>
...
sudo yum -y install ipmitool libvirt libvirt-devel firewalld jq libguestfs virt* qemu* bind-utils bind dhcp-server python3-openstackclient
sudo yum -y upgrade
